...
from backend.routers import models, analytics, sheets, cells, excel_io, users, import_excel, auth, chat, indicator_rules, translations
...
if _dist.is_dir():
    ...
    async def serve_spa(full_path: str):
        ...
        return FileResponse(str(_dist / "index.html"), headers={"Cache-Control": "no-cache, no-store, must-revalidate"})
